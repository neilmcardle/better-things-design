          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <motion.div
                ...
                className="luxury-card p-8 group rounded-[4px]"
              >
                <div className="mb-6">
        ...
        <motion.div style={{ y: portfolioY }} className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <motion.div
              ...
              className="luxury-card p-8 md:p-10 flex flex-col items-center rounded-[4px]"
            >
        ...
        <motion.div style={{ y: testimonialsY }} className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.1 }}
              className="luxury-card p-8 md:p-10 rounded-[4px]"
            >
              <div className="mb-8">
                <svg
